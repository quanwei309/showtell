...
tf.flags.DEFINE_string("input_val_file_pattern", "",
...
tf.flags.DEFINE_integer("num_eval_examples", 320,
...
def run():
  ...
  with g.as_default():
    ...
    model_config.input_file_pattern = FLAGS.input_val_file_pattern
...
def main(unused_argv):
  assert FLAGS.input_val_file_pattern, "--input_file_pattern is required"
